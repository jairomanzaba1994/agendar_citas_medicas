...
class CancelScheduleEmail extends Notification
{
    use Queueable;
    protected $user;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ...
                    ->line('Se le informa que su cita médica con el doctor ' . $this->appointment->doctor->name . ' programada con fecha ' . $this->appointment->schedule_date . '
